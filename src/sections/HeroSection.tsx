  ...
  return (
    <section className="pt-12 flex items-center justify-center">
      <div>
        ...
        <h1 className="z-50 mt-6 font-lora font-semibold text-7xl max-xl:text-5xl text-center leading-[90px]">
        ...
        <h3 className="mt-4 text-foreground text-base font-inter font-medium leading-7 text-center ">
        ...
        <div className="mt-24 flex items-center justify-center gap-24 max-xl:gap-10 max-lg:gap-3">
